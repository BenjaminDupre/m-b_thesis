...
public class FingerModelController : MonoBehaviour
{
    ...
    public Quaternion[][] RotateBone(Quaternion quatProximal, Quaternion quatDistal, float thumbFlex = -1)
    {
        Quaternion[][] fingersRotations = fingerMotionSensor.RotateBonesWithoutRestrictions(quatProximal, quatDistal, thumbFlex);
