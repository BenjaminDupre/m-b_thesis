...
A pivotal finding in interoceptive research has revealed the impact of visceral signals on our processing of external stimuli. Lets consider this research into two groups: the psichophysical influence and the congnitive influence of the heart-cycle.  

The first group, describes specific brain mechanisms responsible for predicting signals within the body (heart), that play a crucial role in diminishing our perception of external signals like touch, vision, and auditory cues \parencite{esra_p, AL2021118247, Grund643, motyka, Park2014}. This muting effect has been well-documented in psychophysical experimental setups and individual sensory modalities. Recently it has expand into sensory integration. A new study has shows how the cardiac phase influences multisensory integration \parencite{SALTAFOSSI2023108642}. Using the Race Model Inequality (RMI) approach, stimuli presented during diastole, showed a a higher level of integration for Audio-Tactile and Visuo-Tactile stimuli compared to the one presented during systole. This effect was not as strong for the Audio-Visual stimuli.

The second group of studies has looked into the influence of interoceptive signals directly on cognitive processes. For example, exploring the impact of locked-cardiac phases on cognitive functions such as attention and memory. An illustrative study is the phase-locked cardiac-cycle word retention study conducted by \Cite{Garfinkel2013-st} (phase-lock stimuli refers to the stimuli that is presented during a particular cardiac cycle). On this study, it was found that words detected during systole were less effectively remembered compared to those detected during diastole \parencite{Garfinkel2013-st}. Recent variations in experimental setups, that involved presenting stimuli outside phase-locked periods, have shown that this phenomena works also for  eye seccade active sampling of the environment. It suggests that more eye movement occurs during systolic phases while more fixation happens during diastolic phases \parencite{GalvezPol2018ActiveSI}, thus showing an active perceptual role. 

As the relevance of cardiac-cycle phases in sensory integration and cognitive processes becomes more evident, research aims to develop theories that encompass multiple of these observations. For exmaple, one proposed model, involves understanding interoceptive processes through a predictive coding framework. A particular computatoinal proposed model employs simulated agents and a predictive-coding computational framework to explain results observed in heart-rate variability \parencite{Allen2022}. These theoretical constructs have far-reaching implications in cognition, but must so far be constructed using heart-rate signals alone. 

There is a need to test these computational or theoretical generalizations of interoceptive signals. And for this, there is a need to bridge the gap between the cognitive and perceptual experimental set-ups. There is a growing need for ecological validity. more specifically, a need to simultaneously test, perceptual stimulation, multisensory integration, and cognitive outcomes. This approach would align experiments more closely with real-world scenarios, improving ecological validity and help to understand how body-brain phenomena translate into human psychology \parencite{schmuckler2001ecological}.
...
To develop the comparative approach, I followed the steps outlined in my reference studies \parencite{Innes2019ACA, SALTAFOSSI2023108642, Ulrich2007}, albeit limited by having only one simple stimulus available instead of two. The initial step involved testing the validity of stimulus construction by analyzing and modeling reaction times to uni-modal and bi-modal stimuli. My results indicated that responses to multisensory pairs ($V=T$), ($V \neq T$) were faster than those to unimodal stimuli ($V$). This observation in VR mirrors the redundant signal effect, suggesting that redundant conditions (two sensory signals) elicit quicker reaction times compared to the single sensory condition \parencite*{SALTAFOSSI2023108642}.
