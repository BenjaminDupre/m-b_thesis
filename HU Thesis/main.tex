...
The virtual environment simulated a retangular office with a window. 
To synchronize the data streams (i.e., behavioral reports, hand positions, fingers positions,ECG), we used custom C\# scripts and network-based communication (i.e., timestamps). 
