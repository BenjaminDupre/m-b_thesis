...
% Dont know well what to to do with this paragraph. 
%The most relevant aspect of IVR and what makes it such a potentially useful methodology is that the user is in a state of ‘suspension of disbelief’, or a state where knowledge of the unreality of the VR world and belief in its experiential reality coexists. Although participants typically behave similarly in VR to how they would behave in a comparable situation in reality \parencite{deGelder2018VirtualRA,Slater2009PlaceIA}, they know that what happens to them in VR is not real in the same sense to that what happens outside IVR is.  Nonthelesss, as benchmarked by the cognitive and emotional processes deployed by the brain and body, vritual expirirences resemble the ones in real-life. 

%Of particular interest is the capacity IVR has to elicit psychophysical reactions, as one can view IVR as a continuation of a long psychophysical tradition that attempts to interfere with our perception in order to clarify its underlying mechanism. The most relevant aspect of IVR and what makes it such a potentially useful methodology is that the user is in a state of ‘suspension of disbelief’, or a state where knowledge of the unreality of the VR world and belief in its experiential reality coexists. Although participants typically behave similarly in VR to how they would behave in a comparable situation in reality \parencite{deGelder2018VirtualRA,Slater2009PlaceIA}, they know that what happens to them in VR is not real in the same sense to that what happens outside IVR is.  This suspension of reality is not new to us. In other media, like theater or movies, atendees are willing to go along with the author and let havoc with their reponses and emotions. This responses can be triggered without the belief in the reality of the expirience. Likewise, certain psychophysical reponses can be harnessed in IVR.
